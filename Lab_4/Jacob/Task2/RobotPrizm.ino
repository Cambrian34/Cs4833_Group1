      ...
      case 2:
        {
          ...
          prizm.setMotorPowers(125,10);      // please note that here we hardcode the speed of the motor, you can adjust my code and transfer the speed value you want through the serial communication
          break;
        }
      // turn right
      case 3:
        {
          ...
          prizm.setMotorPowers(10,125);      // please note that here we hardcode the speed of the motor, you can adjust my code and transfer the speed value you want through the serial communication
          break;
        }
